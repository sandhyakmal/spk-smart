...
<body>
    <div class="wrapper">
        ...
        @endphp
        <!-- End Ative route helper functions -->
                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                                    aria-expanded="false">
                                    <div class="avatar-sm d-flex justify-content-center align-items-center"
                                        style="width: 40px; height: 40px; border-radius: 50%; overflow: hidden; font-size: 16px; font-weight: bold; color: white;">
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $(document).on('click', '.note-btn', function(e) {
                ...
                $('.note-btn-group .dropdown-menu').not($(this).closest('.note-btn-group').find(
