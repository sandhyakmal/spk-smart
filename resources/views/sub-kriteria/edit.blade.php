        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs mb-3 p-0 m-0 border-0">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a>Edit Sub Kriteria</a></li>
                </ul>
            </div>
            ...
            <form action="{{ route('kriteria-sub.update', $subKriteria->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="card-title">Edit Sub Kriteria</div>
                            </div>
