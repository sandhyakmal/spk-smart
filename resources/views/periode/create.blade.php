        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs mb-3 p-0 m-0 border-0">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a>Create Periode</a></li>
                </ul>
            </div>
            ...
            {{-- SUBMIT NORMAL --}}
            <form action="{{ route('periode.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="card-title">Create Periode</div>
                            </div>
                            ...
                            <div class="card-body px-4 px-md-5 py-4">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        @enderror" 
                                            name="tahun" id="tahun" value="{{ old('tahun', date('Y')) }}" placeholder="Tahun" min="1900" max="{{ date('Y') + 10 }}" />
                                        @error('tahun')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
