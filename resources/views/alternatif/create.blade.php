        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs mb-3 p-0 m-0 border-0">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a>Create Alternatif</a></li>
                </ul>
            </div>
            ...
            <form action="{{ route('alternatif.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="card-title">Create Alternatif</div>
                            </div>
                                            ...
                                            <select
                                                ...
                                                @foreach ($kriteria->subKriterias as $subKriteria)
                                                    <option value="{{ $subKriteria->id }}"
                                                        {{ old('sub_kriteria_id.' . $kriteria->id) == $subKriteria->id ? 'selected' : '' }}>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end gap-2 mt-3">
                            <a href="{{ route('alternatif.index') }}" class="btn btn-black">
                                Cancel
                            </a>
